...
<TabItem value="KeyDB" label="KeyDB" default>
...
services:
  keydb:
    ...
    ulimits:
      memlock: -1
    volumes:
      - /home/user/keydb:/data                  
      - /home/user/keydb/keydb.conf:/etc/keydb/keydb.conf
``` 
 </TabItem>

<TabItem value="KeyDB Config file" label="KeyDB Config file" default>
...
- [安装KeyDB](https://docs.keydb.dev/docs/open-source-getting-started/) 
